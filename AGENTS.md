...
- Home Assistant does not own Hermes runtime settings or credentials; do not add translated Home Assistant, model, provider, or other Hermes runtime configuration fields.
